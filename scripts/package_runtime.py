...
KEEP_SCRIPTS = ('agent.py', 'api_server.py', 'connection.py', 'custom_provider.py', 'fal_provider.py', 'generate.py', 'image_ops.py', 'image_store.py', 'playground.py', 'provider_base.py', 'responses_provider.py', 'runtime_paths.py', 'security.py', 'skill.py', 'task_schema.py', 'task_store.py', 'version.py')
